  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
	    ...
	    <li class="active"><a href="#"><span class="btn btn-info btn-sm"><span class="glyphicon glyphicon-search"></span> Search</a></li>
    ...
    <div class="container">
       ...
       <div class="well well-sm">Search this site</div>

        <!-- Image Header -->
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="http://localhost/projects/nna-nl/images/search1.PNG" width="100" height="100" alt="">
            </div>
        </div>
		</div
        <!-- /.row -->
