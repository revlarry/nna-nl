...
//echo "<h2>Sub-directory NOW : ".$sub_dir2."</h2>";
	//exit;
	...
	//echo "Full path -- >".	$filename."<br>";
	//echo "File basename -- >".	basename($filename)."<br>";

	
	//imagejpeg($image_p,$filename , 100); // output to file
	//$statusOK = imagejpeg($image_p,basename($filename), 100); // output to file
