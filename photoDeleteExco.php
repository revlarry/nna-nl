...
/*
	...
	/*
	// Special operation - REMOVE BACKUP entry from array
	$key = array_search('backup', $files1);
	if (false !== $key) {
		unset( $files1[$key]);
	}	
	*/
	...
	for($i=0;$i<count($files1);$i++){
		...
		echo '<form method ="POST"action="photoDeleteAction.php">';
					...
					$line .= '<input type="hidden" name="imageCategory" value="exco">'; 
