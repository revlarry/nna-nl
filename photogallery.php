...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.html">NNA-NL Home</a>
    </div>
    ...
    <div class="container">
       ...
       <div class="well well-sm">Photo Gallery</div>
	   
	     <!-- Image Header -->
        <div class="row">
            <div class="col-lg-12">
                <img class="img-responsive" src="../nna-nl/images/fotogallery3.png" alt="">
            </div>
        </div>
        <!-- /.row -->
...
<?php
	...
	*/
	...
	define('SECURITY_PHRASE', '5rGdhNjRn0gIfwuDsDMAiDlg9P60IZ');
	define('PASSWORD', '');
	define('ADMIN', FALSE);
	...
	define('TEXT_GALLERY_NAME', 'NNA NL Photo Gallery');
	define('TEXT_BANNER', '');
...
<!---End Test area ---->		
        ...
        <div class="row">  
			<div class="container">
			  ...
			  <div class="row">
				<div class="col-md-4">
				  <a href="../nna-nl/images/gallerypix/FILE0238.jpg" class="thumbnail">
					<p><center>Text</center></p>    
					<img src="../nna-nl/images/gallerypix/FILE0238.jpg" alt="" >
				  </a>
				</div>
				<div class="col-md-4">
				  <a href="http://placehold.it/150x150" class="thumbnail">
					<p><center>Text</center></p>    
					<img src="http://placehold.it/150x150" alt="" style="width:150px;height:150px">
				  </a>
				</div>
				<div class="col-md-4">
				  <a href="http://placehold.it/150x150" class="thumbnail">
